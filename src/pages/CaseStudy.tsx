  ...
  return (
    <Layout>
      ...
      <section className="container-editorial pt-24 md:pt-32 pb-12 md:pb-16">
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-2">
            <span className="label-uppercase text-muted-foreground">Case Study</span>
          </div>
      ...
      <section className="container-editorial pb-16 md:pb-24">
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-2">
            <span className="label-uppercase text-muted-foreground">Overview</span>
          </div>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 md:col-span-10">
            <div className="grid md:grid-cols-2 gap-12 md:gap-16">
              <div>
                <span className="label-uppercase text-muted-foreground block mb-4">Challenge</span>
                <p className="text-body text-muted-foreground">
                  {project.challenge}
                </p>
              </div>
              ...
              <div>
                <span className="label-uppercase text-muted-foreground block mb-4">Solution</span>
                <p className="text-body text-muted-foreground">
                  {project.solution}
                </p>
              </div>
      ...
      <section className="container-editorial pb-24 md:pb-32">
        <div className="flex items-center gap-3 mb-8 md:mb-12">
          ...
          <span className="label-uppercase">Latest Work</span>
        </div>
